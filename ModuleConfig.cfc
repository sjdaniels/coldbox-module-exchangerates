...
component {
	...
	this.webURL 			= "";
	this.description 		= "Module for getting currency exchange rate info via Exchangerate-api.com";
	this.version			= "1.0.0";
	...
	// Module Entry Point
	// this.entryPoint			= "exchangerates";
	// Inherit Entry Point
	// this.inheritEntryPoint 	= false;
	// Model Namespace
	this.modelNamespace		= "exchangerates";
	// CF Mapping
	this.cfmapping			= "exchangerates";
	// Auto-map models
